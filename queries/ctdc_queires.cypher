...
RETURN t.clinical_trial_id AS Trial_ID, t.clinical_trial_designation AS Trial_Code,
       ...
       i_pten.ihc_test_result AS PTEN_IHC_Status,
       i_mlh1.ihc_test_result AS MLH1_IHC_Status,
       i_msh2.ihc_test_result AS MSH2_IHC_Status,
       i_rb.ihc_test_result AS RB_IHC_Status,
       ar.assignment_outcome AS Assignment_Outcome,
